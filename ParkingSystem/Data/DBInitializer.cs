...
namespace ParkingSystem.Models
{
    public static class DbInitializer
    {
        public static void Initialize(ParkingSystemContext context)
        {
            ...
            { 
            new ParkingSlot{Plate="HN11 AQW", TimeIn=DateTime.Parse("2005-09-01 12:11"), TimeOut=DateTime.Parse("2005-09-01 15:13"),CustomerID=1 },
            new ParkingSlot{Plate="ES11 AQW", TimeIn=DateTime.Parse("2005-09-01 12:11"), TimeOut=DateTime.Parse("2005-09-01 16:13"),CustomerID=2 },
            new ParkingSlot{Plate="HN01 AQW", TimeIn=DateTime.Parse("2005-09-01 12:42"), TimeOut=DateTime.Parse("2005-09-01 17:13"),CustomerID=3 },
            new ParkingSlot{Plate="HN44 AQW", TimeIn=DateTime.Parse("2005-09-01 10:13"), TimeOut=DateTime.Parse("2005-09-01 18:13"),CustomerID=4 },
            new ParkingSlot{Plate="HN11 ZEE", TimeIn=DateTime.Parse("2005-09-01 12:56"), TimeOut=DateTime.Parse("2005-09-01 19:13"),CustomerID=5 },
            new ParkingSlot{Plate="HN11 DEE", TimeIn=DateTime.Parse("2005-09-01 11:13"), TimeOut=DateTime.Parse("2005-09-01 21:13"),CustomerID=6 }
